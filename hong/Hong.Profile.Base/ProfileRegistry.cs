...
namespace Hong.Profile.Base
{
	...
	public class ProfileRegistry : ProfileBase
	{
		// Fields
		...
		public ProfileRegistry(RegistryKey rootKey, string subKeyName) :
			base("")
		{
			if (rootKey != null)
				m_rootKey = rootKey;
		...
		public ProfileRegistry(ProfileRegistry reg) :
			base(reg)
		{
		...
		{
			return new ProfileRegistry(this);
		}
