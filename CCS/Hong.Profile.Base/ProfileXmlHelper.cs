...
namespace Hong.Profile.Base
{
	...
	public abstract class ProfileXmlBased : ProfileBase
	{
		...
		protected ProfileXmlBased(string fileName) :
			base(fileName)
		{
		}
		...
		protected ProfileXmlBased(ProfileXmlBased profile) :
			base(profile)
		{
	...
	{
		private ProfileXmlBased m_profile;
		...
		/// <exception cref="UnauthorizedAccessException">
		///	  Attempting to lock the file and ReadWrite access is not permitted by the operating system. </exception>
		internal XmlBuffer(ProfileXmlBased profile, bool lockFile)
		{
			m_profile = profile;
